    ...
    <div class="bg-white rounded-lg shadow-lg max-w-xl w-full max-h-screen overflow-y-auto">
        ...
        <form id="createUOMForm" action="{{ route('setting.uom') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="text-end">
                ...
                <button type="button" id="closeCreateUOMPopup" class="bg-gray-300 hover:bg-gray-400 text-gray-900 px-4 py-2 rounded-md ml-2 focus:outline-none" onclick="window.location.reload();">CANCEL</button>
            </div>
        </form>
    </div>
</div>
