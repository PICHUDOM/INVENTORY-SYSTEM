...
<div class="bg-gray-100">
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold mb-4">DETAIL INGREDIENT INFORMATION</h1>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4 mt-2">
            ...
            <div class="bg-white p-2 rounded-lg shadow-md flex flex-col">
                ...
                <div class="mt-auto flex justify-between p-2">
                    ...
                    <div class="relative group">
                        <button class="add-ingredient-btn bg-green-500 text-white px-3 py-1 rounded cursor-pointer transition duration-300 hover:bg-green-600 flex items-center space-x-1"
                            data-menu-id="{{ $menuId }}">
